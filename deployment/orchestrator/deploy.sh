#!/bin/bash
# Deployment script for Orchestrator Agent to AgentCore Runtime
# Requirements: 2.1, 2.2, 3.1

set -e

echo "============================================"
echo "Deploying Orchestrator Agent to AgentCore"
echo "============================================"
...
agentcore launch \
  ...
  --env "DYNAMODB_AGENT_REGISTRY_TABLE=AgentRegistry" \
