#!/bin/bash
# Deployment script for Trade Data Extraction Agent to AgentCore Runtime
# Requirements: 2.1, 2.2, 3.3

set -e

echo "================================================"
echo "Deploying Trade Extraction Agent to AgentCore"
echo "================================================"
...
ENTRYPOINT="trade_extraction_agent.py"
...
TEST_PAYLOAD='{
  ...
  "canonical_output_location": "s3://'"${S3_BUCKET}"'/extracted/COUNTERPARTY/test_001.json"
}'
...
echo ""
echo "================================================"
echo "Trade Extraction Agent deployed successfully!"
echo "================================================"
echo ""
